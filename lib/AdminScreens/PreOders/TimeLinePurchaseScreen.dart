...
class TimeLinePurchaseScreen extends StatefulWidget {
  TimeLinePurchaseScreen({Key key}) : super(key: key);

  @override
  _TimeLinePurchaseScreenState createState() => _TimeLinePurchaseScreenState();
}

class _TimeLinePurchaseScreenState extends State<TimeLinePurchaseScreen> {
