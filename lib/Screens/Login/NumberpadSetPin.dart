...
class Numberpadsetpin extends StatefulWidget {
  final int length;
  final Function onChange;
  final Function onClear;
  Numberpadsetpin({Key key, this.length, this.onChange, this.onClear})
      : super(key: key);

  @override
  _NumberpadsetpinState createState() => _NumberpadsetpinState();
}

class _NumberpadsetpinState extends State<Numberpadsetpin> {
  String number = '';
...
class NumpadButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: OutlineButton(
        borderSide:
            haveBorder ? BorderSide(color: Colors.red[400]) : BorderSide.none,
