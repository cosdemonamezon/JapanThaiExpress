...
class TimeLinePurchaseMember extends StatefulWidget {
  // TimeLineDepository({Key key, Object argument}) : super(key: key);

  @override
  _TimeLinePurchaseMemberState createState() => _TimeLinePurchaseMemberState();
}

class _TimeLinePurchaseMemberState extends State<TimeLinePurchaseMember> {
